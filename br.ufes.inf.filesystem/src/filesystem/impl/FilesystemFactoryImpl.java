...
public class FilesystemFactoryImpl extends EFactoryImpl implements FilesystemFactory {
	...
	public static FilesystemFactory init() {
		try {
			FilesystemFactory theFilesystemFactory = (FilesystemFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.example.org/filesystem"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case FilesystemPackage.LINK: return createLink();
			default:
