...
/**
 * This is the item provider adapter for a {@link filesystem.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_node_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_node_feature", "_UI_Link_type"),
				 FilesystemPackage.Literals.LINK__NODE,
				 true,
				 false,
				 true,
				 null,
