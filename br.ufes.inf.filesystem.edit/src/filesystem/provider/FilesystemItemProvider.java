...
public class FilesystemItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FilesystemPackage.Literals.FILESYSTEM__NODES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Filesystem.class)) {
			case FilesystemPackage.FILESYSTEM__NODES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FilesystemPackage.Literals.FILESYSTEM__NODES,
		...
		newChildDescriptors.add
			(createChildParameter
				(FilesystemPackage.Literals.FILESYSTEM__NODES,
				 FilesystemFactory.eINSTANCE.createLink()));
	}
