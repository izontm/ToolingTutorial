...
public class FilePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public FilePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject file, String editing_mode) {
		...
		partKey = FilesystemViewsRepository.File.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (file.getName() != null && isAccessible(FilesystemViewsRepository.File.Properties.name))
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == FilesystemViewsRepository.File.Properties.name) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (FilesystemViewsRepository.File.Properties.name == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {
			...
			if (FilesystemPackage.eINSTANCE.getNode_Name().equals(msg.getFeature()) && basePart != null && isAccessible(FilesystemViewsRepository.File.Properties.name)) {
